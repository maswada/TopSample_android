...
public class ContentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Integer steps = getIntent().getIntExtra("STEPS", 0);


        String message = steps.toString();
        String title = null;
        if (steps == 0) {
            message += getString(R.string.message_level0);
            title = getString(R.string.button_title0);
        }
        else if ((steps > 0) && (steps <= 7000)) {
            message += getString(R.string.message_level1);
            title = getString(R.string.button_title1);
        }
        else if ((steps > 7000) && (steps <= 10000)) {
            message += getString(R.string.message_level2);
            title = getString(R.string.button_title2);
        }
        else if (steps > 10000) {
            message += getString(R.string.message_level3);
